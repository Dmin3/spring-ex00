...
<body>
	...
	<div class="container">
		<div id="alert1" class="alert alert-primary" role="alert" hidden >
			...
			<div class="col-12">
				<form>
					<div class="form-group">
						<label for="input1">제목</label> <input readonly id="input1"
							class="form-control" name="title" value="${board.title }">
					</div>
					<div class="form-group">
						<label for="textarea1">내용</label>
						<textarea readonly id="textarea1" class="form-control"
							name="content">
					...
					<div class="form-group">
						<label for="input2">작성자</label> <input readonly id="input2"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						<input type="submit" value="${board.bno }" readonly hidden
							id="reply-bno-input1">
						<div class="form-group">
	...
	<div class="modal fade" id="reply-modify-modal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						<input type="text" value="" hidden readonly id="reply-rno-input2">
						<input type="submit" value="${board.bno }" readonly hidden id="reply-bno-input2">
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">작성자</label> <input
								type="text" class="form-control" id="reply-replyer-input2" readonly="readonly">
						</div>
						<div class="form-group">
							<label for="message-text" class="col-form-label">댓글</label>
